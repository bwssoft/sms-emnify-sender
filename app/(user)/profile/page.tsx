    ...
    <div className="min-h-full">
      ...
      <form className="p-4 sm:px-6 lg:px-8" action={changeUserPassword}>
        <div className="grid grid-cols-2 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3">
          ...
          <div className="grid grid-rows-3 gap-x-6 gap-y-4 sm:grid-cols-6 md:col-span-2">
            <div className="col-span-full">
              <label htmlFor="new_password" className="block text-sm font-medium leading-6 text-gray-900">Nova senha</label>
              <div className="mt-2">
                <input 
                  type="password" 
                  name="new_password" 
            ...
            <div className="col-span-full">
              <label htmlFor="confirm_new_password" className="block text-sm font-medium leading-6 text-gray-900">Confirmar nova senha</label>
              <div className="mt-2">
                <input 
                  type="password" 
